...
export async function GET(req: NextRequest) {
  ...
  const allBranches = [
    ...
    { name: "CRYSTAL KUY",              address: "Ruko Sentral Niaga Kalimalang Blok B1 No.16, Kayuringin Jaya, Kec. Bekasi Sel., Kota Bekasi, Jawa Barat 17144",                                         maps_url: "https://maps.app.goo.gl/6qdwQh1TUGrAR78b6",  map_url: "https://maps.app.goo.gl/6qdwQh1TUGrAR78b6",  sort_order: 3,  active: true },
    ...
    { name: "Strawberry Spa & Therapy", address: "Ruko Kawasan Niaga Citra Grand Cibubur, Jl. Alternatif Cibubur No.26, Jatisampurna, Kota Bekasi, Jawa Barat 17435",                                    maps_url: "https://maps.app.goo.gl/5MpCHHkRdqGFbSpT7",  map_url: "https://maps.app.goo.gl/5MpCHHkRdqGFbSpT7",  sort_order: 6,  active: true },
