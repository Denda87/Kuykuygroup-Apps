          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 7, marginTop: 6 }}>
                ...
                <span style={{ fontSize: 11, color: "rgba(202,162,61,.7)" }}>★ 4.9</span>
              </div>
            </div>
          </div>
      ...
      <div style={{ padding: "0 20px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={{ background: CARD_BG, border: CARD_BORDER, borderRadius: 20, padding: 18 }}>
          ...
          <div style={{ height: 6, background: "rgba(202,162,61,.1)", borderRadius: 99, overflow: "hidden" }}>
            <div style={{ height: "100%", width: `${pct}%`, background: `linear-gradient(90deg,${GOLD_DARK},${GOLD_LIGHT})`, borderRadius: 99 }} />
          </div>
