    ...
    <div style={{ backgroundColor: "#08070a", color: "#fff", minHeight: "100vh", fontFamily: "Georgia, 'Times New Roman', serif" }}>
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: 1280, margin: "0 auto", padding: "0 2rem", paddingTop: 72, width: "100%" }}>
          <div style={{ maxWidth: 700 }}>
            ...
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 64 }}>
              <Link href="/layanan" className="gold-btn" style={{
                padding: "15px 40px", borderRadius: 999, background: GOLD,
                color: "#1a1100", fontWeight: 700, fontSize: 13,
                letterSpacing: "0.14em", textDecoration: "none", textTransform: "uppercase",
                boxShadow: "0 8px 32px rgba(212,175,55,0.45)", fontFamily: "sans-serif",
              }}>
                Lihat Layanan
              </Link>
              <Link href="/cabang" className="hero-outline-btn" style={{
      ...
      <section style={{ padding: "100px 0", background: "#0c0b00" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 3rem)", fontWeight: 700, marginBottom: 14, letterSpacing: "0.02em" }}>Standar Premium,<br /><span style={GOLD_TEXT}>Pengalaman Tak Terlupakan</span></h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 28 }}>
            {[
              ...
              <div key={title} className="feature-card" style={{
                ...
                <h3 style={{ fontSize: 18, fontWeight: 700, color: "#D4AF37", marginBottom: 12, letterSpacing: "0.03em" }}>{title}</h3>
      ...
      <section style={{ padding: "100px 0", background: "#08070a" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56 }}>
            ...
            <Link href="/layanan" style={{ display: "flex", alignItems: "center", gap: 6, color: "#D4AF37", textDecoration: "none", fontSize: 13, fontFamily: "sans-serif", fontWeight: 600, letterSpacing: "0.08em" }}>
              ...
              return (
                <div key={s.id} className="service-card" style={{
                  ...
                  <div style={{ height: 220, overflow: "hidden", position: "relative" }}>
                    ...
                    <img src={imgSrc} alt={s.name} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.5s" }} />
                    ...
                    <div style={{ position: "absolute", top: 14, right: 14, padding: "4px 12px", borderRadius: 999, background: "rgba(212,175,55,0.2)", border: "1px solid rgba(212,175,55,0.4)", fontSize: 11, color: "#D4AF37", fontFamily: "sans-serif", fontWeight: 600 }}>
                      {s.duration_minutes} mnt
                    </div>
                  </div>
                  <div style={{ padding: "22px 24px 28px" }}>
                    <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 8, letterSpacing: "0.02em" }}>{s.name}</h3>
                    {s.description && (
                      <p style={{ fontSize: 13, color: "#7a7060", lineHeight: 1.7, marginBottom: 16, fontFamily: "sans-serif" }}>{s.description}</p>
                    )}
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ fontSize: 22, fontWeight: 800, ...GOLD_TEXT, fontFamily: "sans-serif" }}>
                        Rp {s.price_idr.toLocaleString("id-ID")}
                      </div>
                      <Link href="/layanan" style={{
                        padding: "8px 20px", borderRadius: 999, background: GOLD,
                        color: "#1a1100", fontWeight: 700, fontSize: 11,
      ...
      <section style={{ padding: "80px 0", background: "#0c0b00" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "clamp(1.1rem, 2vw, 1.6rem)", color: "#c8bfa8", fontStyle: "italic", maxWidth: 700, margin: "0 auto 20px", lineHeight: 1.7 }}>
            &ldquo;Pelayanan luar biasa! Terapis sangat profesional dan tempatnya sangat nyaman. Pasti akan kembali lagi!&rdquo;
          </p>
      ...
      <section style={{
        ...
        background: "linear-gradient(135deg, #1a1400 0%, #0f0c00 50%, #1a1400 100%)",
        ...
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)", fontWeight: 700, marginBottom: 20, lineHeight: 1.2 }}>
            Rasakan Perbedaan<br /><span style={GOLD_TEXT}>Sentuhan Premium</span>
          </h2>
          <p style={{ color: "#9a8a6a", fontSize: 15, lineHeight: 1.8, marginBottom: 40, fontFamily: "sans-serif" }}>
            Temukan cabang terdekat kami dan buat reservasi hari ini. Tim kami siap menyambut Anda.
          </p>
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/cabang" className="gold-btn" style={{
              padding: "15px 44px", borderRadius: 999, background: GOLD,
              color: "#1a1100", fontWeight: 700, fontSize: 13,
              letterSpacing: "0.14em", textDecoration: "none", textTransform: "uppercase",
