  ...
  return (
    <div className="flex items-center justify-between px-4 py-3.5"
      ...
      <button
        ...
        style={{ background: value ? "linear-gradient(135deg, #C9A84C, #D4AF37)" : "#222" }}
      >
        <div
...
function LinkRow({ icon: Icon, label, sub }: { icon: React.ElementType; label: string; sub?: string }) {
  return (
      ...
      <div className="px-4 py-4 flex flex-col gap-4">
        ...
        <div className="rounded-2xl overflow-hidden"
          ...
          <div className="flex items-center gap-3 px-4 py-3"
            style={{ borderBottom: "1px solid #D4AF3725" }}>
