...
import { LayoutDashboard, UserCog, Layers, CalendarClock, Target, MapPin, FileText, Settings, LogOut, Search, ShoppingCart, DoorOpen, AlarmClock, Wallet, BarChart2 } from "lucide-react";
...
const adminNavItems: NavItem[] = [
  ...
  { type: "link", label: "Kinerja Karyawan", icon: BarChart2, href: "/dashboard/kinerja" },
