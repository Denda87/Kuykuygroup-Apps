...
const CONTACT_ITEMS = [
  {
    ...
    sub: "Senin – Minggu, 09:00 – 22:00",
  },
  {
    icon: Mail,
    title: "Email",
    value: "hello@kuykuygroup.com",
    sub: "Respons dalam 24 jam",
  },
  {
    icon: MapPin,
    title: "Lokasi",
    value: "Bekasi · Bogor · Cikarang",
    sub: "6 cabang di Jabodetabek",
  },
  {
    icon: Clock,
              ...
              {CONTACT_ITEMS.map((item, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontSize: 11, letterSpacing: "0.14em", color: "#6b5f3e", textTransform: "uppercase", marginBottom: 4 }}>
                        {item.title}
                      </div>
                      <div style={{ fontSize: 15, fontWeight: 600, color: "#e8d9b0", marginBottom: 2 }}>
                        {item.value}
                      </div>
          ...
          >
            {submitted ? (
              ...
              >
                ...
                <p style={{ color: "#6b5f3e", fontSize: 15, lineHeight: 1.7 }}>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                  <div>
                    <label style={{ display: "block", fontSize: 12, letterSpacing: "0.1em", color: "#6b5f3e", textTransform: "uppercase", marginBottom: 8 }}>
                      Nama Lengkap
                    </label>
                    <input
                      type="text"
