    ...
    <div style={{ backgroundColor: "#08070a", color: "#fff", minHeight: "100vh", fontFamily: "Georgia, 'Times New Roman', serif" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem", height: 72, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 36, fontSize: 13, letterSpacing: "0.06em" }}>
            {[["Home","#home"],["Tentang Kami","#tentang"],["Layanan Spa","#layanan"],["Menu Pijat","#menu"],["Lokasi Cabang","#lokasi"],["Kontak","#kontak"]].map(([label, href]) => (
              <a key={label} href={href} style={{ color: "#c8bfa8", textDecoration: "none", transition: "color 0.2s" }}
      ...
      <section id="home" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          background: "linear-gradient(105deg, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.65) 50%, rgba(0,0,0,0.25) 100%)",
        }} />
        {/* Gold shimmer overlay */}
        <div style={{
          position: "absolute", inset: 0, zIndex: 2,
          background: "radial-gradient(ellipse at 20% 60%, rgba(212,175,55,0.08) 0%, transparent 60%)",
        }} />
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: 1280, margin: "0 auto", padding: "0 2rem", paddingTop: 72, width: "100%" }}>
          <div style={{ maxWidth: 680 }}>
            ...
            <h1 style={{ fontSize: "clamp(2.6rem, 5vw, 4.2rem)", fontWeight: 800, lineHeight: 1.1, marginBottom: 24, margin: "0 0 24px 0" }}>
      ...
      <section id="layanan" style={{ padding: "100px 0", background: "#0f0d00" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, letterSpacing: "0.35em", color: "#D4AF37", marginBottom: 12, textTransform: "uppercase", fontFamily: "sans-serif" }}>
              ✦ Layanan Kami ✦
            </div>
              ...
              return (
                <div key={s.id} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16, cursor: "pointer" }}>
                  <div style={{
                    ...
                    onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.border = "2px solid rgba(212,175,55,0.9)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "0 0 60px rgba(212,175,55,0.3)"; }}
                    onMouseOut={e => { (e.currentTarget as HTMLDivElement).style.border = "2px solid rgba(212,175,55,0.4)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "0 0 40px rgba(212,175,55,0.12)"; }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
            {services.map((s) => (
              <div key={s.id}
                ...
                onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.6)"; (e.currentTarget as HTMLDivElement).style.transform = "translateY(-6px)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "0 20px 60px rgba(212,175,55,0.15)"; }}
                onMouseOut={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.18)"; (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "none"; }}>
                {/* Image strip */}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>
            {branches.map((b) => (
              <div key={b.id}
                ...
                onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.5)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 40px rgba(212,175,55,0.1)"; }}
                onMouseOut={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.18)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "none"; }}>
                {/* Gold top accent */}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
              <div style={{ position: "relative" }}>
                ...
                {/* Main circle with spa image */}
                <div style={{
                  width: 300, height: 300, borderRadius: "50%",
                  border: "3px solid rgba(212,175,55,0.5)",
                  overflow: "hidden",
                  boxShadow: "0 0 80px rgba(212,175,55,0.18), inset 0 0 60px rgba(0,0,0,0.4)",
                }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                ...
                <div style={{
                  ...
                  color: "#1a1100", fontWeight: 700, fontSize: 11, lineHeight: 1.3,
                  textAlign: "center", fontFamily: "sans-serif", letterSpacing: "0.04em",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
            {testimonials.map((t) => (
              <div key={t.id}
                ...
                onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.45)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "0 16px 50px rgba(212,175,55,0.1)"; }}
                onMouseOut={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.18)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "none"; }}>
                {/* Quote mark */}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24, maxWidth: 900, margin: "0 auto" }}>
            {teamMembers.map((m, i) => (
              <div key={i} style={{
                ...
                onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.5)"; (e.currentTarget as HTMLDivElement).style.transform = "translateY(-4px)"; }}
                onMouseOut={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.18)"; (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)"; }}>
                <div style={{
                  width: 80, height: 80, borderRadius: "50%",
                  background: GOLD,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  margin: "0 auto 20px",
                  fontSize: 28, fontWeight: 800, color: "#1a1100",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 24, marginBottom: 48 }}>
            {[
              ...
              <div key={title as string} style={{
                ...
                onMouseOver={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.5)"; }}
                onMouseOut={e => { (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(212,175,55,0.18)"; }}>
                <div style={{
                  width: 56, height: 56, borderRadius: 14,
                  background: GOLD,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  margin: "0 auto 20px", fontSize: 20, color: "#1a1100",
      ...
      <footer id="kontak" style={{ background: "#050400", padding: "72px 0 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                {[Share2, Share2, Mail].map((Icon, i) => (
                  <a key={i} href="#" style={{
                    ...
                    onMouseOver={e => { (e.currentTarget as HTMLAnchorElement).style.background = "rgba(212,175,55,0.12)"; (e.currentTarget as HTMLAnchorElement).style.border = "1px solid rgba(212,175,55,0.5)"; }}
                    onMouseOut={e => { (e.currentTarget as HTMLAnchorElement).style.background = "transparent"; (e.currentTarget as HTMLAnchorElement).style.border = "1px solid rgba(212,175,55,0.25)"; }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {services.map(s => (
                  <li key={s.id} style={{ marginBottom: 10 }}>
                    <a href="#menu" style={{ color: "#8a7a50", fontSize: 13, textDecoration: "none", fontFamily: "sans-serif", transition: "color 0.2s" }}
                      onMouseOver={e => (e.currentTarget.style.color = "#D4AF37")}
                      onMouseOut={e => (e.currentTarget.style.color = "#8a7a50")}>
                      {s.name}
                    </a>
                  </li>
                ))}
          ...
          <div style={{ borderTop: "1px solid rgba(212,175,55,0.1)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ color: "#4a4030", fontSize: 12, fontFamily: "sans-serif" }}>
              © 2025 Kuykuy Group. All rights reserved.
            </div>
            <div style={{ color: "#4a4030", fontSize: 12, fontFamily: "sans-serif", letterSpacing: "0.06em" }}>
              Premium Spa & Wellness Indonesia
            </div>
          </div>
        </div>
      </footer>
