      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            {weekData.map((d, i) => {
              ...
              return (
                <div key={d.day} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 6, height: "100%" }}>
                  ...
                  {/* day label */}
                  <div style={{ fontSize: 9, color: isToday ? GOLD : "#4a4640", fontWeight: isToday ? 700 : 400, letterSpacing: "0.03em" }}>{d.day}</div>
                </div>
              );
            })}
          </div>
        ...
        <div style={{ background: CARD_BG, border: CARD_BORDER, borderRadius: 20, padding: 20 }}>
          ...
          <div style={{ height: 10, background: "rgba(202,162,61,.08)", borderRadius: 99, overflow: "hidden" }}>
            <div style={{ height: "100%", width: `${monthlyPct}%`, background: `linear-gradient(90deg,${GOLD_DARK},${GOLD_LIGHT})`, borderRadius: 99, transition: "width .5s" }} />
          </div>
