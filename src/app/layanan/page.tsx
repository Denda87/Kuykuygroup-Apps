                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      padding: 8,
                      background: "linear-gradient(to top, rgba(8,7,10,0.5) 0%, transparent 60%)",
                    }}
                  >
                    <span style={{ fontSize: 22 }}>{emoji}</span>
                  </div>
                </div>
                <span style={{ fontSize: 13, color: "#c8b88a", fontWeight: 600, textAlign: "center", maxWidth: 120 }}>
                  {s.name}
                </span>
              </div>
            );
              ...
              >
                ...
                <div style={{ padding: "24px 22px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <span style={{ fontSize: 12, color: "#6b5f3e", background: "rgba(212,175,55,0.08)", padding: "4px 10px", borderRadius: 20 }}>
