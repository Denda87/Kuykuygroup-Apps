export default function Logo({ size = 40 }: { size?: number }) {
  ...
  return (
    <svg width={size} height={h} viewBox="0 0 400 472" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ===== LEFT WING ===== */}
      <g opacity="0.85">
        {/* Main wing body - large sweeping feather mass */}
      ...
      {/* ===== OUTER SHIELD — left half gray ===== */}
      <path d="M200 18 L358 70 L358 248 Q358 380 200 448 Q42 380 42 248 L42 70 Z"
        fill="url(#gLeft)" clipPath="url(#cLeft)"/>
      {/* ===== OUTER SHIELD — right half black ===== */}
      <path d="M200 18 L358 70 L358 248 Q358 380 200 448 Q42 380 42 248 L42 70 Z"
      ...
      {/* ===== RED KUK EMBLEM ===== */}
      {/*
        The KUK logo: two K shapes mirrored with a U connecting them at the bottom,
        forming a heraldic cross-like emblem. All red.
      */}
