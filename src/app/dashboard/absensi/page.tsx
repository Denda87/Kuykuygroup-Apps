...
export default function AbsensiPage() {
  ...
  const pctTarget = total ? Math.round(data.filter(r => r.targetDaily > 0).reduce((s, r) => s + (r.customersToday / r.targetDaily), 0) / data.filter(r => r.targetDaily > 0).length * 100) : 0;
