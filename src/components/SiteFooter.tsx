      ...
      >
        ...
        >
          <div>
            ...
            >
              Pengalaman relaksasi premium di Jabodetabek. Kami menghadirkan layanan spa berkualitas tinggi dengan sentuhan tradisional dan modern untuk kesejahteraan Anda.
            </p>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {QUICK_LINKS.map((link) => (
                <Link key={link.href} href={link.href} className="footer-link" style={{ fontSize: 14 }}>
                  {link.label}
                </Link>
              ))}
            </div>
        ...
        >
          <p style={{ color: "#4a4030", fontSize: 13, letterSpacing: "0.04em" }}>
